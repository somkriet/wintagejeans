                ...
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            ...
                            <p class="text-light">รายการสินค้าในระบบ</p>
                        </h4>
                        <span class="count">18</span>

                        <div class="chart-wrapper px-0" style="height:10px;" height="70">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <p class="text-light">จำนวนยอดขายเดือนกรกฏาคม</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        ...
                        <p class="text-light">พนักงานที่มียอดขายสูงสุด</p>
