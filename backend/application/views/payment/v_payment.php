            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <th scope="col">รหัสการชำระซื้อ</th>
                  <th scope="col">ผู้แจ้งชำระ</th>
              ...
              <tbody>
                <?php 
                    ...
                    <tr>
                      ...
                      <td><?php echo $c->user_pay;?></td>
                      <td><?php echo $c->chance_pay;?></td>
                      <td><?php echo $c->amount_pay;?></td>
                      <td><?php echo $c->date_pay;?></td>
                      <td><?php echo $c->list_pay;?></td>
